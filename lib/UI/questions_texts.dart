...
class QuestionTextState extends State<QuestionText> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fontSizeAnimationController = new AnimationController(duration: new Duration(milliseconds: 800), vsync: this);
  ...
  Widget build(BuildContext context) {
    ...
    return new Material(
      color: Colors.white,
      child: new Padding(
        padding: new EdgeInsets.symmetric(vertical: 13.0, horizontal: 10.0),
        child: new Center(
          child: new Text(
            "Pergunta de número: " + widget._questionNumber.toString() + "\n " + widget._question.toString(), 
